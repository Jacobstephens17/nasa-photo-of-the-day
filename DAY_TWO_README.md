...
- [1] Our goal here is to apply advance styling techniques for your React application.
...
- [1] Refactor your project using a component library that was covered in class (Reactstrap or styled-components).
- [1] Implement and use at least a few styled components to beautify your project.
